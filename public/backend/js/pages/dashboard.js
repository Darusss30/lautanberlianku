...
$(function () {
  ...
  'use strict';
	...
	var options = {
        ...
        if(document.querySelector("#chart41")) {
	...
	var options = {
        ...
        if(document.querySelector("#chart42")) {
	...
	var options = {
      ...
      if(document.querySelector("#charts_widget_43_chart")) {
	...
	var options = {
        ...
        if(document.querySelector("#revenue1")) {
	...
	var options = {
        ...
        if(document.querySelector("#revenue2")) {
