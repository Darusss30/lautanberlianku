...
Route::get('/vehicle', [CategoryController::class, 'VehicleCategoryView'])->name('vehicle.category');

// Sparepart Category Routes  
Route::get('/sparepart', [CategoryController::class, 'SparepartCategoryView'])->name('sparepart.category');

// Specific Sub Category Routes
Route::get('/subcategory/bodykit', [SubCategoryController::class, 'BodyKitView'])->name('subcategory.bodykit');
Route::get('/subcategory/partengine', [SubCategoryController::class, 'PartEngineView'])->name('subcategory.partengine');
Route::get('/subcategory/tires', [SubCategoryController::class, 'TiresView'])->name('subcategory.tires');
Route::get('/subcategory/oil', [SubCategoryController::class, 'OilView'])->name('subcategory.oil');
Route::get('/subcategory/partlawas', [SubCategoryController::class, 'PartLawasView'])->name('subcategory.partlawas');
...
Route::post('/generate-code', [ProductController::class, 'generateProductCode'])->name('product.generate.code');
...
Route::get('/delete/{id}', [AdminProfileController::class, 'DeleteUser'])->name('delete.user');
...
// Vehicle and Sparepart Pages Routes
Route::get('/vehicles', [IndexController::class, 'VehiclesPage'])->name('vehicles.page');
Route::get('/spareparts', [IndexController::class, 'SparepartsPage'])->name('spareparts.page');
Route::get('/category/vehicles/{id}/{slug}', [IndexController::class, 'CategoryVehicles'])->name('category.vehicles');
Route::get('/category/spareparts/{id}/{slug}', [IndexController::class, 'CategorySpareparts'])->name('category.spareparts');
