...
@section('title')
{{ $category->category_name }} - Kendaraan
@endsection
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                ...
                <div class="side-menu animate-dropdown outer-bottom-xs">
                    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i> Kategori Kendaraan</div>
                    <nav class="yamm megamenu-horizontal">
                        <ul class="nav">
                            @foreach($vehicleCategories as $cat)
                            <li class="dropdown menu-item">
                                <a href="{{ route('category.vehicles', ['id' => $cat->id, 'slug' => $cat->category_slug]) }}" 
                ...
                <div id="category-banner-image">
                    <div class="category-banner">
                        <div class="category-banner-content">
                            ...
                            <p>Temukan berbagai pilihan {{ strtolower($category->category_name) }} berkualitas tinggi</p>
                        </div>
                    </div>
                </div>
                <!-- ========================================== SECTION – HERO : END ========================================= -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="no-products-found">
                                            <div class="text-center">
                                                <i class="fa fa-car fa-5x" style="color: #ddd; margin-bottom: 20px;"></i>
                                                <h3>Belum Ada Produk</h3>
                                                <p>Produk untuk kategori {{ $category->category_name }} belum tersedia.</p>
                                                <a href="{{ route('vehicles.page') }}" class="btn btn-primary">
                                                    Lihat Kategori Lain
                                                </a>
                                            </div>
                                        </div>
