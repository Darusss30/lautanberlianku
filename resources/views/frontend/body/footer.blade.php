            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="module-body">
                        <a href="">
                            <p style="color: #fff;">Lautan Berlian adalah Dealer Kendaraan bermotor merek Mitsubishi yang memiliki jaringan pelayanan, penjualan, perawatan kendaraan, suku cadang serta jasa lainnya.</p>
                        </a>
                    </div>
                    <!-- /.module-body -->
                </div>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-12 no-padding social">
                <p class="text-center" style="color: #ffffff"><i class="fa fa-copyright" aria-hidden="true"></i>2025 Lautan Berlian. All Rights Reserved</p>
            </div>
        </div>
    </div>
</footer>